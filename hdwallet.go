...
// 32-byte digest the chain signs; pre-hash the message with the chain's hash
// function (keccak256 for Ethereum/Tron, double-SHA256 for Bitcoin, SHA-256
// for Cosmos, …). For ed25519 chains (e.g. SOL, XLM, ALGO) data is the message
